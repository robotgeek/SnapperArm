...
//armSequence - This file has been altered manually to include all 4 sequences we will be using
...
// The drinks are named after colors in this demo, but you can rename them.
