/*
 * All instances of playSequence() and playState have been renamed to function with the Mixologist code.
 * playSequence1() and playState1 operate with the Red Sequence
 * playSequence2() and playState2 operate with the Green Sequence
 * playSequence3() and playState3 operate with the Blue Sequence
 * playSequence4() and playState4 operate with the Yellow Sequence
 */
//Arm 5
//Sequence 6
//Mode 2
